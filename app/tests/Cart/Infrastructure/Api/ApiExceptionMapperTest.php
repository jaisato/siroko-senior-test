...
final class ApiExceptionMapperTest extends TestCase
{
    ...
    public static function domainExceptions(): iterable
    {
        ...
        yield 'product not found by code' => [ProductNotFoundException::withCode(ProductCode::fromString('X')), 404];
        yield 'order not found' => [OrderNotFoundException::withId(OrderId::fromString(Uuid::uuid4()->toString())), 404];
        yield 'cart not pending' => [new InvalidCartStatusException('Cart is not pending'), 409];
        yield 'empty cart' => [EmptyCartException::cannotBePaid(), 409];
        ...
        yield 'bad listing filter' => [InvalidProductCriteriaException::invertedPriceRange(), 400];
