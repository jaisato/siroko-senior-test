...
final class OpenApiDocumentationTest extends ApiTestCase
{
    public function test_every_endpoint_is_documented(): void
    {
        ...
        self::assertArrayHasKey('get', $paths['/api/v1/carts']);
        self::assertArrayHasKey('delete', $paths['/api/v1/carts/{cartId}/items/{itemId}']);
        self::assertArrayHasKey('patch', $paths['/api/v1/carts/{cartId}/items/{itemId}']);
        self::assertArrayHasKey('put', $paths['/api/v1/carts/{id}/checkout']);
        self::assertArrayHasKey('put', $paths['/api/v1/carts/{id}/deliver']);
        self::assertArrayHasKey('delete', $paths['/api/v1/carts/{id}']);
        self::assertArrayHasKey('get', $paths['/api/v1/orders/{id}']);
